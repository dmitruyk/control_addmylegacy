...
def site_settings(request):
    ...
    return {
        ...
        "TV_REFRESH_SECONDS": getattr(settings, "TV_REFRESH_SECONDS", 0),
        "TV_WEALTH_POLL_SECONDS": getattr(settings, "TV_WEALTH_POLL_SECONDS", 600),
        "TV_DISPLAY_POLL_SECONDS": getattr(settings, "TV_DISPLAY_POLL_SECONDS", 60),
