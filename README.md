...
44 city/nature/cosmos photographs ship in `static/art/slides/` (1920×1080). The slideshow crossfades smoothly; duration and transition are configurable in **Admin → TV display configuration**.
